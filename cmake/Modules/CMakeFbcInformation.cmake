...
ELSE()
  ...
  MACRO(ADD_Fbc_SRC_DEPS Tar)
    ...
    EXECUTE_PROCESS(
      COMMAND ${CMAKE_COMMAND} -E chdir ${CMAKE_CURRENT_SOURCE_DIR} cmakefbc_deps ${_file} ${_src}
      )
    INCLUDE(${_file})
  ...
  FUNCTION(BAS_2_C CFiles)
    ...
    IF(NOT ARG_NO_DEPS)
      EXECUTE_PROCESS(
        COMMAND ${CMAKE_COMMAND} -E chdir ${CMAKE_CURRENT_SOURCE_DIR} cmakefbc_deps ${_deps} ${fbc_src}
        )
      INCLUDE(${_deps})
