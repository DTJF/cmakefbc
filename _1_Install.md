...
Before you can use (or install) the \Proj package you have to have
...
to copy the \CMake macros in to your local \CMake installation (omit
`sudo` on non-LINUX systems).
