...
file(s) `install_manifest.txt`. Ie. on Debian LINUX (or Ubuntu) type
...
the [Doxygen generator](http://www.doxygen.org/) and the [fb-doc
tool](https://github.com/dtjf/fb-doc) to filter the FreeBASIC source
code. Generate html files in folder doc/html by executing
