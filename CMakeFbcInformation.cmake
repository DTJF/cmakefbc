...
IF(NOT CMAKE_Fbc_CREATE_SHARED_LIBRARY)
	SET(CMAKE_Fbc_CREATE_SHARED_LIBRARY
  	"<CMAKE_Fbc_COMPILER> <CMAKE_SHARED_LIBRARY_Fbc_FLAGS> <LANGUAGE_COMPILE_FLAGS> <LINK_FLAGS> ${CMAKE_SHARED_LIBRARY_CREATE_Fbc_FLAGS} <CMAKE_SHARED_LIBRARY_SONAME_Fbc_FLAG><TARGET_SONAME> -x <TARGET> <OBJECTS> -Wl '<LINK_LIBRARIES>'")
ENDIF()
...
IF(NOT CMAKE_Fbc_LINK_EXECUTABLE)
  SET(CMAKE_Fbc_LINK_EXECUTABLE
    "<CMAKE_Fbc_COMPILER> <FLAGS> <CMAKE_Fbc_LINK_FLAGS> <LINK_FLAGS> -x <TARGET> <OBJECTS> -Wl '<LINK_LIBRARIES>'")
ENDIF()
